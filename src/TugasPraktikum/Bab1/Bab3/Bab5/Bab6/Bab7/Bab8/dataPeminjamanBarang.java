...
public abstract class dataPeminjamanBarang extends Inventory_BarangKantor {
    String nama_peminjam, nama_barangpinjam, tanggal_peminjaman, lokasi_barang;
    ...
    void lokasiBarang(String lokasiBarang){
        this.lokasi_barang = lokasiBarang;
    }
